 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "df = pd.DataFrame([{\"Number of Unique Items\": unique_items, \"Average Price\": average_price,\"Number of Purchases\":\n",
    "                  no_of_purchases,\"Total Revenue\":total_revenue }])\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    total_unique_players = group[\"SN\"].nunique()\n",
    "    percentage = ((total_unique_players/len(purchase_data[\"SN\"].unique())) * 100)\n",
    "    count_by_gender.append(total_unique_players)\n",
    "    percentage_by_gender.append(percentage)\n",
    "\n",
    "df = pd.DataFrame({\"\":gender_list,\"Total Count\":count_by_gender,\"Percentage of Players\":percentage_by_gender})\n",
    "df.set_index('',inplace=True)\n",
    "df = df.reindex(index = ['Male','Female','Other / Non-Disclosed'])\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "for row,group in grouped_df:\n",
    "    gender_list.append(row)\n",
    "    purchase_count.append(len(group[\"Purchase ID\"]))\n",
    "    average_purchase_price.append(group[\"Price\"].sum()/len(group[\"Price\"]))\n",
    "    total_purchase = group[\"Price\"].sum()\n",
    "    total_purchase_value.append(total_purchase)\n",
    "    avg_total_purchase_per_person.append(total_purchase/group[\"SN\"].nunique())    \n",
    "df = pd.DataFrame({\"Gender\":gender_list,\"Purchase Count\": purchase_count,\"Average Purchase Price\": average_purchase_price,\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "purchase_data[\"Age_Group_Summary\"] = pd.cut(purchase_data[\"Age\"],bins,labels=groups)\n",
    "grouped_df = purchase_data.groupby(by='Age_Group_Summary')\n",
    "group_list = []\n",
    "total_count = []\n",
    "percentage_of_players = []\n",
    "total_population = len(purchase_data[\"SN\"].unique())\n",
    "for row,group in grouped_df:\n",
    "    group_list.append(row)\n",
    "    count = group[\"SN\"].nunique()\n",
    "    total_count.append(count)\n",
    "    percentage_of_players.append(count/total_population * 100)\n",
    "summary_age_demo = pd.DataFrame({\"\":group_list,\"Total Count\":total_count,\"Percentage of Players\":percentage_of_players})\n",
    "summary_age_demo[\"Percentage of Players\"] = summary_age_demo[\"Percentage of Players\"].map(\"{:.2f}\".format)\n",
    "summary_age_demo.set_index(\"\",inplace=True)\n",
    "summary_age_demo\n",
    "    \n",
    "    "
   ]
  ...
  },
  {
   ...
   "source": [
    ...
    "for row,group in grouped_df:\n",
    "    group_list.append(row)\n",
    "    count = group[\"SN\"].count()\n",
    "    purchase_count.append(count)\n",
    "    total_purchase = group[\"Price\"].sum()\n",
    "    average_purchase_price.append(total_purchase/count)\n",
    "    total_purchase_value.append(total_purchase)\n",
    "    avg_total_purchase_per_person.append(total_purchase/group[\"SN\"].nunique())\n",
    "\n",
    "puchasing_analysis_df = pd.DataFrame({\"\":group_list,\"Purchase Count\":purchase_count,\"Average Purchase Price\":\n",
    "                                     average_purchase_price,\"Total Purchase Value\":total_purchase_value,\n",
    "                                     \"Avg Total Purchase per Person\":avg_total_purchase_per_person})\n",
    "\n",
    "puchasing_analysis_df.set_index(\"\",inplace=True)\n",
    "puchasing_analysis_df = puchasing_analysis_df.reindex(index=[\"10-14\",\"15-19\",\"20-24\",\"25-29\",\"30-34\",\"35-39\",\"40+\",\"<10\"])\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    average = total/count\n",
    "    purchase_count.append(count)\n",
    "    average_purchase_price.append(average)\n",
    "    total_purchase_value.append(total)\n",
    "\n",
    "top_spenders = pd.DataFrame({\"SN\": name_list,\"Purchase Count\": purchase_count,\n",
  ...
  },
  {
   ...
   "source": [
    "grouped_df = purchase_data.groupby(\"Item ID\")\n",
    "item_list = []\n",
    "item_name = []\n",
    "purchase_count = []\n",
    "item_price = []\n",
    ...
    "    item_name.append(group[\"Item Name\"].iloc[0])\n",
    "    purchase_count.append(group[\"Purchase ID\"].count())\n",
    "    item_price.append(group[\"Price\"].iloc[0])\n",
    "    total_Purchase_value.append(group[\"Price\"].sum())\n",
    "most_popular_items_df = pd.DataFrame({\"Item ID\":item_list,\"Item Name\":item_name,\"Purchase Count\":purchase_count,\n",
  ...
  },
  {
   ...
   "source": [
    "most_profitable_items_df = pd.DataFrame({\"Item ID\":item_list,\"Item Name\":item_name,\"Purchase Count\":purchase_count,\n",
    "                                     \"Item Price\": item_price,\"Total Purchase Value\":total_Purchase_value})  \n",
    "most_profitable_items_df = most_profitable_items_df.sort_values(\"Total Purchase Value\",ascending=False)\n",
    "most_profitable_items_df.set_index([\"Item ID\",\"Item Name\"],inplace=True)\n",
